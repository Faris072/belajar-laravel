...
@section('cdn')
    <form action="/fasilitas/manage" method="POST">
        ...
        <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control" placeholder="Masukkan deskripsi fasilitas..."></textarea>
        <br><br>
        <label for="gambar">Input Gambar</label><br>
        <input type="file" name="gambar" id="gambar" class="btn btn-primary">
        <br><br>
        ...
        <input type="number" name="harga" id="Harga" class="form-control" value="" placeholder="Masukkan Harga Lain...">
        <br><br>
